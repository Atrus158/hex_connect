...
<div class="wrapper about_wrapper">
	...
	<div class="main_content">
		<h1 class="about_head">About the Connection Game</h1>
	</div>
	...
	<div class="about_content">
		...
		<p>There are numerous connections that I haven't managed to catalog in the database, so the key message that
				you should pay attention to is the one that says "No connection found in database."
				In other words, "Yeah, there may be a connection, it just hasn't been added."
				If you feel there it should be, please email me at 
				<a href="mailto:basdude@aol.com">basdude@aol.com</a>.
		</p>

		<p><b>Speaking of that, can I suggest additional subjects/nodes?</b></p>
		<p>Yes, absolutely.  I encourage it.  The one caveat is that occasionally I won't add suggestions 
			...
			Incidentally, that is also why I haven't tied it into something like the Internet Movie Database.
		</p>
		...
		<p>The database was created using MySQL Workbench.  The underlying layout for the hexagonal grid and the maze
			...
			<a href="https://github.com/Atrus158/hex_connect.git" target="_blank">https://github.com/Atrus158/hex_connect.git<a>.  
